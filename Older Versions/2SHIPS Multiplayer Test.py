...
cheat_player_autofire = 1
cheat_player_autofire_delay = 100
...
cheat_enemy_autofire = 1
cheat_enemy_autofire_delay = 100
...
def does_collide(missile, object2):
    ...
    for i in hitboxes1:
        pygame.draw.rect(window, YELLOW, tuple(i) + (1, 1))
    for i in hitboxes2:
        pygame.draw.rect(window, YELLOW, tuple(i) + (1, 1))
...
path_font_UI = path_gameResources.replace("Older Versions/", "") + "fonts/BigNoodleTooOblique.ttf"
